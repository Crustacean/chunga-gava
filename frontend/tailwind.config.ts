  ...
  theme: {
    extend: {
      colors: {
        ...
        systemBackground: "var(--color-system-background)",
        secondarySystemBackground: "var(--color-secondary-system-background)",
        tertiarySystemBackground: "var(--color-tertiary-system-background)",
        label: "var(--color-label)",
        secondaryLabel: "var(--color-secondary-label)",
